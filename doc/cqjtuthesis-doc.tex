...
\begin{itemize}
    \item \textbf{版本}: v1.0.1
    \item \textbf{更新日期}: 2026-02-02
...
\textbf{编译命令}: \texttt{cd examples \&\& xelatex cqjtuthesis-bachelor.tex}
...
\textbf{编译命令}: \texttt{cd examples \&\& xelatex cqjtuthesis-master.tex}
...
\textbf{内容目录}: \texttt{examples/contents-graduate/} \\
\textbf{编译命令}: \texttt{cd examples \&\& xelatex cqjtuthesis-professional.tex}
...
\textbf{内容目录}: \texttt{examples/contents-graduate/} \\
\textbf{编译命令}: \texttt{cd examples \&\& xelatex cqjtuthesis-doctor.tex}
